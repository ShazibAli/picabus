...
public class ReportsListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView report = (TextView)vi.findViewById(R.id.artist); 
        TextView timeOfReport = (TextView)vi.findViewById(R.id.duration); 
      ...
      //  imageLoader.DisplayImage(song.get(CustomizedListView.KEY_THUMB_URL), reporterImage);
