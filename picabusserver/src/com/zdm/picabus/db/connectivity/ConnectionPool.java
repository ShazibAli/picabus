...
public class ConnectionPool {
	...
	private static boolean startConnectionPool (int initNumOfConnections, int maxNumOfConnections, String hostAddress, String port,
	...
	public static Connection getConnection() {
		...
		if (!isInitialized) {
			IniReader ini = new IniReader("./src/com/zdm/picabus/db/connectivity/iniConfigs.ini"); 
